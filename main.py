...
class BSWord(QMainWindow):
    def __init__(self):
        ...
        self.showMaximized()
        self.setWindowTitle('Hasan BS Word')
    ...
    def create_tool_bar(self):
        ...
        self.font_size_box.valueChanged.connect(self.set_font_sixe)
        tool_bar.addWidget(self.font_size_box)


        self.addToolBar(tool_bar)

    def set_font_sixe(self):
        value= self.font_size_box.value()
        self.editor.setFontPointSize(value)

    def save_as_pdf(self):
        file_path, _ = QFileDialog.getSaveFileName(self, 'Hasan BS Word > Export PDF', None, 'PDF Files (*.pdf)')
